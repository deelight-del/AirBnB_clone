...
class TestAmenity(unittest.TestCase):
    """Class definition of the TestCases for the Amenity"""
    def setUp(self):
        """Set up method"""
        self.obj1 = Amenity()
        self.obj2 = Amenity()
    ...
    def test_print_str(self):
        ...
        self.assertRegex(print_str, r"^\[Amenity\] \([^)]+\) \{[^}]*\}")
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(save_dict["__class__"], "Amenity")
    ...
    def test_init(self):
        """ This method will test the init method of the Amenity class """
        attrs_dict = {"id": str(uuid4())}
        obj = Amenity(**attrs_dict)
        ...
        self.assertNotEqual(class_name_attr, "Amenity")
        # Vary the created_at.
    ...
    def test_save_reload(self):
        ...
        fs = FileStorage()
        obj1 = Amenity()  # This will use the save method.
        obj2 = Amenity()
        obj2.save()
        fs.reset()
        ...
        self.assertIsInstance(expected_vals[0], Amenity)
