...
class TestState(unittest.TestCase):
    """Class definition of the TestCases for the State"""
    def setUp(self):
        """Set up method"""
        self.obj1 = State()
        self.obj2 = State()
    ...
    def test_print_str(self):
        ...
        self.assertRegex(print_str, r"^\[State\] \([^)]+\) \{[^}]*\}")
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(save_dict["__class__"], "State")
    ...
    def test_init(self):
        """ This method will test the init method of the State class """
        attrs_dict = {"id": str(uuid4())}
        obj = State(**attrs_dict)
        ...
        self.assertNotEqual(class_name_attr, "State")
        # Vary the created_at.
    ...
    def test_save_reload(self):
        ...
        fs = FileStorage()
        obj1 = State()  # This will use the save method.
        obj2 = State()
        obj2.save()
        fs.reset()
        ...
        self.assertIsInstance(expected_vals[0], State)
    ...
    def test_new_attributes(self):
        ...
        local_dict = {"id": "1234", "name": "foo"}
        local_obj = State(**local_dict)
