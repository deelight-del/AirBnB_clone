...
class TestCity(unittest.TestCase):
    """Class definition of the TestCases for the City"""
    def setUp(self):
        """Set up method"""
        self.obj1 = City()
        self.obj2 = City()
    ...
    def test_print_str(self):
        ...
        self.assertRegex(print_str, r"^\[City\] \([^)]+\) \{[^}]*\}")
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(save_dict["__class__"], "City")
    ...
    def test_init(self):
        """ This method will test the init method of the City class """
        ...
        self.assertNotEqual(class_name_attr, "City")
        # Vary the created_at.
    ...
    def test_save_reload(self):
        ...
        fs = FileStorage()
        obj1 = City()  # This will use the save method.
        obj2 = City()
        obj2.save()
        fs.reset()
        ...
        self.assertIsInstance(expected_vals[0], City)
    ...
    def test_new_attributes(self):
        ...
        self.obj1.name = "foo"
        self.obj1.state_id = "1234"
        self.assertEqual(self.obj1.name, "foo")
        self.assertEqual(self.obj1.state_id, "1234")
        local_dict = {"state_id": "1234", "name": "foo"}
        local_obj = City(**local_dict)
        self.assertEqual(local_obj.name, "foo")
        self.assertEqual(local_obj.state_id, "1234")
